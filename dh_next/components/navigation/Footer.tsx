        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-neutral-600 max-w-xs">
              Bringing nature indoors with premium plants and accessories for your home and office.
            </p>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:col-span-3">
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2 text-sm text-neutral-600">
                <Link href="#" className="hover:text-primary">All Plants</Link>
                <Link href="#" className="hover:text-primary">Indoor Plants</Link>
                <Link href="#" className="hover:text-primary">Outdoor Plants</Link>
                <Link href="#" className="hover:text-primary">Planters</Link>
                <Link href="#" className="hover:text-primary">Plant Care</Link>
              </nav>
            </div>
            ...
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2 text-sm text-neutral-600">
                ...
                <Link href="#" className="hover:text-primary">Our Team</Link>
            ...
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2 text-sm text-neutral-600">
                ...
                <Link href="#" className="hover:text-primary">Plant Care Guides</Link>
